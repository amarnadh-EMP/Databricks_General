...
file_location = "wasbs://"+container+"@"+storage_account_name+".blob.core.windows.net/FilePath.<csv/txt/xlsx>"
file_type = "csv"
...
#dbutils.fs.ls("wasbs://"+container+"@"+storage_account_name+".blob.core.windows.net/")

# COMMAND ----------

df = spark.read.format(file_type).option("inferSchema", "true").option("header","true").csv(file_location)
